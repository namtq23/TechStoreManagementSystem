...
public class WHImport extends HttpServlet {
  ...
  String warehouseId=(String) request.getSession().getAttribute("warehouseId");
    ...
    try {
        ...
        List<StockMovementsRequest> importRequests = reqDAO.getImportRequests(dbName, warehouseId);
       
        for (StockMovementsRequest importRequest : importRequests) {
        ...
        e.printStackTrace();
        request.setAttribute("error", "Lỗi khi tải danh sách đơn nhập hàng.");
    }
