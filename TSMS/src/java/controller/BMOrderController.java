...
public class BMOrderController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            if (userIdObj == null || roleIdObj == null || dbNameObj == null || Integer.parseInt(roleIdObj.toString()) != 1) {
            ...
            List<OrdersDTO> ordersList = orderDAO.getFilteredOrdersListByPage(
                    dbName, page, pageSize, branchId, selectedCreators,
            ...
            req.setAttribute("selectedBranch", branchId);
        ...
        try {
            ...
            if ("update".equals(action)) {
                try {
                    ...
                    resp.sendRedirect("bm-orders?success=update");
                } catch (IOException | NumberFormatException e) {
                    resp.sendRedirect("bm-orders?error=update");
                }
                ...
                try {
                    ...
                    resp.sendRedirect("bm-orders?success=delete");
                } catch (IOException | NumberFormatException | SQLException e) {
                    resp.sendRedirect("bm-orders?&error=delete");
                }
            }
        } catch (IOException | NumberFormatException e) {
            System.out.println(e);
