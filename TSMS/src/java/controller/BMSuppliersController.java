...
@WebServlet(name = "BMSuppliersController", urlPatterns = {"/bm-supplier"})
public class BMSuppliersController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/WEB-INF/jsp/manager/suppliers.jsp").forward(req, resp);
    }
}
