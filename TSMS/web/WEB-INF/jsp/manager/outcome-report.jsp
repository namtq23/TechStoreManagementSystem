<%-- 
    Document   : outcome-report (Branch Manager version)
...
<html lang="vi">
    <head>
        ...
        <title>TSMS - Báo cáo chi phí chi nhánh</title>
    ...
    <body>
      ...
      <header class="header">
        ...
        <div class="main-container">
            <!-- Sidebar -->
            <aside class="sidebar">
                <form action="bm-outcome" method="get" class="filter-form">
                    <fieldset>
                        ...
                        <!-- Thay thế phần current-branch-info -->
                        <div class="filter-item">
            ...
            <main class="main-content">
                <div class="page-header">
                    <h1>Báo cáo chi phí chi nhánh</h1>
                ...
                <div class="total-summary">
                    <div class="summary-item">
                        <span class="summary-label">Tổng chi phí chi nhánh:</span>
                ...
                <!-- Pagination -->
                <form method="GET" action="bm-outcome">
                        ...
                        <div class="pagination">
                            ...
                            <c:choose>
                                <c:when test="${currentPage > 1}">
                                    <a href="bm-outcome?page=1&recordsPerPage=${recordsPerPage}&employeeId=${employeeId}&fromDate=${dateFrom}&toDate=${dateTo}&paymentMethod=${paymentMethod}" class="page-btn">
                            ...
                            <c:choose>
                                <c:when test="${currentPage > 1}">
                                    <a href="bm-outcome?page=${currentPage - 1}&recordsPerPage=${recordsPerPage}&employeeId=${employeeId}&fromDate=${dateFrom}&toDate=${dateTo}&paymentMethod=${paymentMethod}" class="page-btn">
                            ...
                            <c:forEach var="i" begin="${currentPage - 2 > 0 ? currentPage - 2 : 1}" 
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <a href="bm-outcome?page=${i}&recordsPerPage=${recordsPerPage}&employeeId=${employeeId}&fromDate=${dateFrom}&toDate=${dateTo}&paymentMethod=${paymentMethod}" class="page-btn">${i}</a>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
                            ...
                            <c:choose>
                                <c:when test="${currentPage < totalPages}">
                                    <a href="bm-outcome?page=${totalPages}&recordsPerPage=${recordsPerPage}&employeeId=${employeeId}&fromDate=${dateFrom}&toDate=${dateTo}&paymentMethod=${paymentMethod}" class="page-btn">
        ...
        <script>
            ...
            function exportToExcel() {
                ...
                var url = 'export-excel?type=outcome-bm' +
                ...
                link.href = url;
                link.download = 'outcome_branch_report.xlsx';
