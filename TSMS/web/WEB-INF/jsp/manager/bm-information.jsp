                    ...
                    <div class="profile-content">
                        ...
                        <div class="profile-avatar">
                            <div class="avatar-image">
                                <c:choose>
                                    <c:when test="${not empty user.avaUrl}">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-section">
                                ...
                                <div class="info-item">
                                    ...
                                    <span class="info-value ${empty user.dob ? 'empty' : ''}">
                                        ${not empty user.dob ? user.dob : 'Chưa cập nhật'}
                                    </span>
                                </div>

                                <div class="info-item">
                                    <span class="info-label">CCCD/Hộ chiếu:</span>
                                    <span class="info-value ${empty user.identificationID ? 'empty' : ''}">
                                        ${not empty user.identificationID ? user.identificationID : 'Chưa cập nhật'}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="info-section">
                                ...
                                <div class="info-item">
                                    ...
                                    <span class="info-value ${empty user.email ? 'empty' : ''}">
                                        ${not empty user.email ? user.email : 'Chưa cập nhật'}
                                    </span>
                                </div>

                                <div class="info-item">
                                    <span class="info-label">Số điện thoại:</span>
                                    <span class="info-value ${empty user.phone ? 'empty' : ''}">
                                        ${not empty user.phone ? user.phone : 'Chưa cập nhật'}
                                    </span>
                                </div>

                                <div class="info-item">
                                    <span class="info-label">Địa chỉ:</span>
                                    <span class="info-value ${empty user.address ? 'empty' : ''}">
                                ...
                                <div class="info-item">
                                    ...
                                    <span class="info-value ${empty user.webURL ? 'empty' : ''}">
                                        <c:choose>
                                            <c:when test="${not empty user.webURL}">
                                                <a href="${user.webURL}" target="_blank" class="website-link">${user.webURL}</a>
                                            </c:when>
                            ...
                            <div class="info-section full-width">
                                <h4><i class="fas fa-building"></i> Thông tin doanh nghiệp</h4>

                                <div class="info-item">
                                    <span class="info-label">Mã số thuế:</span>
                                    <span class="info-value ${empty user.taxNumber ? 'empty' : ''}">
                                        ${not empty user.taxNumber ? user.taxNumber : 'Chưa cập nhật'}
                                    </span>
                                </div>
                                ...
                                <div class="info-item">
                                    ...
                                    <span class="info-value">
                                        <c:choose>
                                            <c:when test="${user.roleID == 1}">Quản trị viên hệ thống</c:when>
                                            <c:when test="${user.roleID == 2}">Quản lý cửa hàng</c:when>
                                            <c:when test="${user.roleID == 3}">Nhân viên bán hàng</c:when>
