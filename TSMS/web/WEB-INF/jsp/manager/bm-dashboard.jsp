...
<html lang="vi">
    <head>
        ...
        <title>TSMS - Chi nhánh - Tổng quan</title>
        ...
        <div class="main-container">
            ...
            <main class="main-content">
                ...
                <section class="sales-results">
                    <h2>KẾT QUẢ BÁN HÀNG HÔM NAY CHI NHÁNH</h2>
    ...
    <div class="metric-value">${currentBranchName}</div>
    <div class="metric-subtitle">ID: ${currentBranchID}</div>
</div>
                ...
                <section class="revenue-chart">
                    <form id="chartFilterForm" action="bm-overview" method="GET">
                        <input type="hidden" name="sortBy" value="${sortBy}">
                        <input type="hidden" name="topPeriod" value="${topPeriod}">
                        <div class="chart-header">
                            <h3>
                                DOANH THU THUẦN CHI NHÁNH
                ...
                <section class="top-products">
                    <div class="section-header">
                        <h3>TOP 5 HÀNG HÓA BÁN CHẠY CHI NHÁNH ${topPeriod == 'last_month' ? 'THÁNG TRƯỚC' : 'THÁNG NÀY'}</h3>
                        <form id="topProductsForm" action="bm-overview" method="GET">
            ...
            <!-- Sidebar - GIỮ NGUYÊN PHẦN CỦA ĐỒNG NGHIỆP -->
            <aside class="sidebar">
                <!-- THÔNG BÁO -->
            ...
            new Chart(ctxTop, {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'TOP 5 HÀNG HÓA BÁN CHẠY CHI NHÁNH ${topPeriod == "last_month" ? "THÁNG TRƯỚC" : "THÁNG NÀY"}'
                        }
                    },
    ...
    new Chart(ctxTop, {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'TOP 5 HÀNG HÓA BÁN CHẠY CHI NHÁNH'
                }
            },
            scales: {x: {beginAtZero: true}}
        }
