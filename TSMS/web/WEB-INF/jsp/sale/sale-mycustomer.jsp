...
<%@ page import="java.util.*, model.CustomerDTO" %>
...
<html lang="vi">
    ...
    <body>
        ...
        <div class="main-container">
            <!-- Sidebar -->
            <aside class="sidebar">
                <form action="sale-mycustomer" method="get">
                    ...
                    <div class="filter-actions">
                        <a href="sale-mycustomer?page=1" class="btn-clear">
            ...
            <main class="main-content">
                ...
                <div class="page-header">
                    ...
                    <div class="header-actions">
                        <form action="sale-mycustomer" method="get" class="search-container">
                                ...
                                <tr id="details-${loop.index}" class="detail-row" style="display: none;">
                                    <td colspan="8">
                                        <div class="detail-container">
                                            <form method="post" action="sale-mycustomer">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <p><strong>Giới tính:</strong>
                                                                    <input type="text" name="gender" class="form-control"
                                                                           value="${customer.fullName ? 'Nữ' : 'Nam'}" readonly=""/>
                                                                </p>
                                                            </div>
                ...
                <div class="pagination-container mt-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="pagination">
                        <%-- First Page --%>
                        <c:url var="firstPageUrl" value="sale-mycustomer">
                        ...
                        <%-- Previous Page --%>
                        <c:url var="prevPageUrl" value="sale-mycustomer">
                        ...
                        <c:forEach begin="1" end="${totalPages}" var="i">
                            <c:url var="pageUrl" value="sale-mycustomer">
                        ...
                        <%-- Next Page --%>
                        <c:url var="nextPageUrl" value="sale-mycustomer">
                            <c:param name="page" value="${currentPage + 1}"/>
                            <c:if test="${not empty keyword}">
                                <c:param name="keyword" value="${keyword}"/>
                            </c:if>
                        ...
                        <%-- Last Page --%>
                        <c:url var="lastPageUrl" value="sale-mycustomer">
