            ...
            <div class="container">
                ...
                <div class="profile-container">
                    ...
                    <div class="profile-content">
                        <form id="profileForm" action="so-information-update" method="POST">
                            ...
                            <div class="info-grid">
                                ...
                                <div class="info-section">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            <input type="text" name="taxNumber" class="form-input" 
                                                   value="${user.taxNumber}" maxlength="20">
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            <input type="url" name="webURL" class="form-input" 
                                                   value="${user.webURL}" placeholder="https://example.com">
                                        </div>
                                    </div>
                                ...
                                <div class="info-section">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="info-value">
                                            <span class="status-badge ${user.isActive == 1 ? 'status-active' : 'status-inactive'}">
                                                ${user.isActive == 1 ? 'Hoạt động' : 'Không hoạt động'}
                                            </span>
                                        </span>
                                    </div>
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="info-value">
                                            <span class="service-package">${user.status}</span>
                                        </span>
                                    </div>
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="info-value">
                                            <span class="expiry-date expiry-warning">
                                                ${user.status == 'TRIAL' ? Validate.formatDateTime(user.trialEnd) : Validate.formatDateTime(user.subscriptionEnd)}
                                            </span>
                                        </span>
                                    </div>
                                </div>
